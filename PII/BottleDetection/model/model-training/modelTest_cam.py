...
detector.setModelPath(os.path.join(execution_path, "PII-Robot-main/PII-Robot-main/BottleDetection/model/model-training/models/tiny-yolov3_dataset_last.pt"))
detector.setJsonPath("PII-Robot-main/PII-Robot-main/BottleDetection/model/model-training/models/dataset_tiny-yolov3_detection_config.json")
detector.loadModel()
